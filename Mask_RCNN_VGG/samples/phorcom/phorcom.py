...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("balloon", 1, "truck")
        self.add_class("balloon", 2, "excavator")
        self.add_class("balloon", 3, "car")
        self.add_class("balloon", 4, "forklift")
        self.add_class("balloon", 5, "equipment")
        self.add_class("balloon", 6, "sundries")
        ...
        for a in annotations:
            ...
            name_dict = {"truck":1, "excavator":2, "car":3, "forklift":4, "equipment":5, "sundries":6}
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            #rr, cc = skimage.draw.polygon((p['all_points_y'], p['all_points_x']), extent=(p['height'], p['width']))
            #mask[rr, cc, i] = 1
